...
public class ShoppinCartServiceTest {
  ...
  // MenuItem menuItem_uno = new MenuItem("681ae25fb76eef217eee214c", "",
  // CategoriItem.BREAKFAST);
  // MenuItem menuItem = new MenuItem("", "680207e38a976e641f7b951b",
  // CategoriItem.BREAKFAST);
  // Items item = new Items(menuItem, 0, 19);
  // Items item_dos = new Items(menuItem_uno, 35, 0);
  // datas.add(item);
  // datas.add(item_dos);
  // assertNotNull(shoppinCartServiceIm.addProducAnShopping(new
  // UpdateShopping("681b61aa1e710924d1408dd6", datas)));
  //
  // }
  //
  // @Test
  ...
  // List<Recipe> recipes =
  // shoppinCartServiceIm.getAllRecipe("681b61aa1e710924d1408dd6");
  ...
  // shoppinCartServiceIm.getAllProduct("681b61aa1e710924d1408dd6");
